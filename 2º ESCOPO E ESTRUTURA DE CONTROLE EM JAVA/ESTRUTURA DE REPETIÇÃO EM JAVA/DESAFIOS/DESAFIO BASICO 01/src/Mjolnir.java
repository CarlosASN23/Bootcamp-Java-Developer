...
Entrada:
@param C - Um número inteiro C será informado, que será a quantidade de casos de teste.
...
Saída:
@return Para cada caso de teste imprima um caractere ‘Y’, caso a pessoa tenha conseguido levantar,
